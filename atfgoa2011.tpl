...
//  init_number Mf
  init_vector M(1,2)
  init_int phase_F40
  init_number median_rec
  init_int median_rec_yrs
  init_int nages_read
  init_int nages
 //selectivity is set to the selectivity at nselages-1 after age nselages 
  init_int nselages
  init_int nselages_srv1
  init_int monot_sel
  init_int monot_sel_srv1
  init_int phase_logistic_sel
  init_int phase_selcoffs
  init_int phase_logistic_sel_srv1
  init_int phase_selcoffs_srv1
  init_vector wt_like(1,8)
...
//reduce nlen by one to cut off 1st length bin 
  ...
  init_matrix nsamples_fish(1,2,1,nobs_fish)
  init_int nobs_srv1
  init_ivector yrs_srv1(1,nobs_srv1) 
  init_int nobs_srv1_length
  init_ivector yrs_srv1_length(1,nobs_srv1_length)
  init_matrix nsamples_srv1_length(1,2,1,nobs_srv1_length)
  init_int nobs_srv1_age
  init_ivector yrs_srv1_age(1,nobs_srv1_age)
  init_vector like_wght(1,5)
  init_matrix nsamples_srv1_age(1,2,1,nobs_srv1_age)
  init_3darray obs_p_srv1_len_r(1,2,1,nobs_srv1_length,1,nlen_r) 
  //!!cout<<"obs_p_srv1_len_r"<<endl;
  //!!cout<<obs_p_srv1_len_r<<endl;
  init_3darray obs_p_srv1_age_read(1,2,1,nobs_srv1_age,1,nages_read)
  init_3darray obs_p_fish_r(1,2,1,nobs_fish,1,nlen_r)
 // !!cout<<"obs_p_fish"<<endl;
 // !!cout<<obs_p_fish<<endl;
  init_vector catch_bio(styr,endyr)
  !!cout<<catch_bio<<endl;
  init_vector obs_srv1(1,nobs_srv1)
  init_vector obs_srv1_sd(1,nobs_srv1)
 //need wt vector by length for split sex?
 //init_vector wt(1,nlen) 
  init_matrix wt(1,2,1,nages)
...
//length age transition matrix
  init_3darray lenage(1,2,1,nages,1,nlen_r-1)
 //LOCAL_CALCS
 //  cout<<nages<<endl;
 //END_CALCS
   int styr_rec; 
...
//  report << F << endl;
  report << "Observed Survey 1:  '1961','1973','1984','1987','1990','1993','1996','1999','2001','2003','2005','2007','2009'" << endl;
